            ...
            <div class="bg-white rounded px-8 py-5 shadow-md border border-gray-200">
                <form action="{{ route('auth.authenticate') }}" method="POST">
                    ...
                    <div class="flex flex-col">
                        ...
                        <label type="email" class="text-gray-800 text-sm mb-2" for="">Username</label>
                        <input
                        ...
                        <a href="{{ route('auth.register') }}" class="text-indigo-500 text-sm pt-4">Don't have an account yet?</a>
                    </div>
                </form>
            </div>
        </div>
